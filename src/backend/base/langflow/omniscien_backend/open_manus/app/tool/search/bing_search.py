...
class BingSearchEngine(WebSearchEngine):
    ...
    def _search_sync(self, query: str, num_results: int = 10) -> list[SearchItem]:
        ...
        # Format the query for URL, spaces to '%20' and special characters URL-encoded
        formatted = requests.utils.quote(query, safe="%20")
        next_url = BING_SEARCH_URL + query + "&mkt=en-US&setLang=EN"
