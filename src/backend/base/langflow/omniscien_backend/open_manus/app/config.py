...
class BrowserSettings(BaseModel):
    ...
    max_content_length: int = Field(10000, description="Maximum length for content retrieval operations")
...
class AppConfig(BaseModel):
    ...
    browser_config: BrowserSettings | None = Field(None, description="Browser configuration")
    search_config: SearchSettings | None = Field(None, description="Search configuration")
    mcp_config: MCPSettings | None = Field(None, description="MCP configuration")
    run_flow_config: RunflowSettings | None = Field(None, description="Run flow configuration")
