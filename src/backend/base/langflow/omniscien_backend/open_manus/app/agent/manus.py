# from langflow.omniscien_backend.open_manus.app.agent.browser import BrowserContextHelper
...
class Manus(ToolCallAgent):
    ...
    system_prompt: str = SYSTEM_PROMPT.format(directory=config.workspace_root, output_file="output.txt")
